...
if (isset($_GET['status'])) {
  $status = $_GET['status'];
  $total_entries_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tbl_pembayaran WHERE payment_status = '$status'");
} else {
  $total_entries_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tbl_pembayaran");
}
...
if (isset($_GET['status'])) {
  $pembayaran = mysqli_query($conn, "SELECT * FROM tbl_pembayaran WHERE payment_status = '$status' LIMIT $entries_per_page OFFSET $offset");
} else {
  $pembayaran = mysqli_query($conn, "SELECT * FROM tbl_pembayaran LIMIT $entries_per_page OFFSET $offset");
}
